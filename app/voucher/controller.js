...
module.exports = {
  index: async (req, res) => {
    try {
      ...
      const voucher = await Voucher.find().populate("category").populate("nominals"); //nampilin data dari category dan nominal
  ...
  actionDelete: async (req, res) => {
    try {
      ...
      //image didalem folder uploadsnya mau dihapus juga:
      let currentImage = `${config.rootPath}/public/uploads/${voucher.thumbnail}`;
      //jika file nya ada didalem folder public, folder uploads:
      if (fs.existsSync(currentImage)) {
        //file akan di remove
